...
public class StopwatchPanelBackup extends JPanel {
    ...
    public StopwatchPanelBackup(MainApp mainApp) {
    ...
    private void init() {
     ...
     // Create a new panel to hold both buttons together
        ...
        btnReplay.setIcon(new FlatSVGIcon("src/Resources/Svg/replay.svg", 25, 25));

...
public class MainAppBackup extends JFrame {
	int hh,mm = 5,ss;
	String state = "paused";
	private Time t;
	...
	public MainAppBackup(){
		init();
	}
	private void init() {
		 	setTitle("Timer");
	        setDefaultCloseOperation(EXIT_ON_CLOSE);
	        ImageIcon icon = new ImageIcon(MainAppBackup.class.getResource("/Resources/Svg/logo.png"));
	        ...
	        btnTimer.setIcon(new FlatSVGIcon("src/Resources/Svg/timer.svg", 25, 25));
	        JButton btnStopwatch = new JButton("Stopwatch");
	        btnStopwatch.setIcon(new FlatSVGIcon("src/Resources/Svg/stopwatch.svg", 25, 25));
	        btnSound = new JToggleButton(""); // Sound icon
	        btnSound.setIcon(new FlatSVGIcon("src/Resources/Svg/volume.svg", 25, 25));
	        ThemeToggle = new JButton(""); // Fullscreen icon
	        ThemeToggle.setIcon(new FlatSVGIcon("src/Resources/Svg/lightMode.svg", 25, 25));
	     ...
	     // Add mouse listener to the label to enter interactive mode
	        ...
	        btnPlay = new JButton("");
	        btnPlay.setIcon(new FlatSVGIcon("src/Resources/Svg/play.svg", 25, 25));
	        ...
	        btnPlay.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					if (state.equals("finished")) {
	                    ...
	                    btnPlay.setIcon(new FlatSVGIcon("src/Resources/Svg/pause.svg", 25, 25));
	                    state = "playing";
	                }
	                else {
	        ...
	        btnSound.addActionListener(new ActionListener() {
	            ...
	            public void actionPerformed(ActionEvent e) {
	                ...
	                if(SoundPlayer.isMuted()) {
	                	btnSound.setIcon(new FlatSVGIcon("src/Resources/Svg/mute.svg", 25, 25));
	                }
	                else
	                	btnSound.setIcon(new FlatSVGIcon("src/Resources/Svg/volume.svg", 25, 25));
	                //for debugging
	        ...
	        ThemeToggle.addActionListener(new ActionListener() {
	            ...
	            public void actionPerformed(ActionEvent e) {
	                ...
	                if(ToggleTheme.isDarkTheme()) {
	                	...
	                	ThemeToggle.setIcon(new FlatSVGIcon("src/Resources/Svg/darkMode.svg", 25, 25));
	                //for debugging
//	                System.out.println(ToggleTheme.isDarkTheme());
	                SwingUtilities.updateComponentTreeUI(MainAppBackup.this); // Refresh the UI
	            }
	        });
	}
	        ...
	        private void addTimerListener() {
	            t.addTimerListener(new TimerListener() {
	                ...
	                public void onTimerComplete() {
	                    ...
	                    btnPlay.setIcon(new FlatSVGIcon("src/Resources/Svg/replay.svg", 25, 25));
	     ...
	     // Method to get hours (HH)
	        ...
	        public static void updateIcons() {
	            ...
	            if (SoundPlayer.isMuted()) {
	                btnSound.setIcon(new FlatSVGIcon("src/Resources/Svg/mute.svg", 25, 25)); // Mute icon
	            } else {
	                btnSound.setIcon(new FlatSVGIcon("src/Resources/Svg/volume.svg", 25, 25)); // Volume icon
	            }

	            // Update the theme button icon based on the current theme (dark/light mode)
	            if (ToggleTheme.isDarkTheme()) {
	                ThemeToggle.setIcon(new FlatSVGIcon("src/Resources/Svg/lightMode.svg", 25, 25)); // Dark mode icon
	            } else {
	                ThemeToggle.setIcon(new FlatSVGIcon("src/Resources/Svg/darkMode.svg", 25, 25)); // Light mode icon
	            }
	        }
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(() -> new MainAppBackup().setVisible(true));
